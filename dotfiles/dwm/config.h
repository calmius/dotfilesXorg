...
static const char col_fg[]          = "#C1c5f3";
static const char col_fgnorm[]      = "#97a1d4";
...
static Key keys[] = {
	...
	{ MODKEY,			            XK_e,      spawn,		   SHCMD("pcmanfm") },
  	{ MODKEY,			            XK_u,      spawn,		   SHCMD("randomWal") },
